  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: "20px", marginTop: 0 }}>Thank you for installing our extension</h2>
        <p>
          This extension helps you enhance your browsing experience with AI-powered features.
      ...
      <div style={{
        ...
        <p>Click on the extension icon in your toolbar to open the main popup and start using the features.</p>
        <button 
          style={{
            background: "#4a86e8",
            color: "white",
